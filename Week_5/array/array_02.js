...
function myAlphabetLength() {
  console.log("Array length:", myAlphabet.length);
...
*/
// Write your code here
let indexFox = zooAnimals.indexOf("Fox");
console.log("Index of Fox:", indexFox);
...
*/
// Write your code here
let indexPenguin = zooAnimals.indexOf("Penguin");
if (indexPenguin === -1) {
